            ...
            <div class="row">
                <div class="col-12">
                    <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                        <h4 class="mb-sm-0">Lista de <strong>Proveedores</strong></h4>

                        <div class="page-title-right">
                            <a href="{{ route('add.supplier') }}" class="btn btn-success waves-effect waves-light"><i
                                    class="fas fa-plus-circle"></i> Agregar Proveedor</a>
                        </div>
                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <h4 class="card-title">Lista datos del <strong>Proveedor</strong></h4>
                            <p class="card-title-desc">Listado de <code>Proveedores</code> incluyendo que persona las dio de
                                alta.</p>

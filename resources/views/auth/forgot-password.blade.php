        ...
        <div class="container-fluid p-0">
            <div class="card">
                <div class="card-body">
                    ...
                    <h4 class="text-muted text-center font-size-18"><b>Recuperar Contraseña</b></h4>
                    ...
                    <div class="p-3">
                        ...
                        <form class="form-horizontal mt-3" method="POST" action="{{ route('password.email') }}">
                            ...
                            <div class="alert alert-info alert-dismissible fade show" role="alert">
                                ¿Olvidaste tu contraseña?. <strong>¡No te preocupes!</strong>. Simplemente háganos saber
                                su dirección de correo electrónico y le enviaremos un enlace para restablecer su

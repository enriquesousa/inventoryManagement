            ...
            <div class="row">
                <div class="col-12">
                    <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                        <h4 class="mb-sm-0">Reporte de <strong>Inventario</strong></h4>

                        <div class="page-title-right">
                            <ol class="breadcrumb m-0">
                                <li class="breadcrumb-item"><a href="javascript: void(0);"></a></li>
                                <li class="breadcrumb-item active">Reporte de <strong>Inventario</strong></li>
                            </ol>
                        </div>
                        ...
                        <div class="card-body">
                            ...
                            <div class="row">
                                <div class="col-6">
                                    <div>
                                        <div class="p-2">
                                            <h3 class="font-size-16">Reporte de <strong>Inventario</strong></h3>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-6 text-end">

            ...
            <div class="row">
                <div class="col-12">
                    <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                        <h4 class="mb-sm-0">Reporte de Productos por <strong>Proveedor</strong></h4>

                        <div class="page-title-right">
                            <ol class="breadcrumb m-0">
                                <li class="breadcrumb-item"><a href="javascript: void(0);"></a></li>
                                <li class="breadcrumb-item active">Reporte de Productos por <strong>Proveedor</strong></li>
                            </ol>
                        </div>
                        ...
                        <div class="card-body">
                            ...
                            <div class="row">
                                <div class="col-6">
                                    <div>
                                        <div class="p-2">
                                            <h3 class="font-size-16">Reporte de Productos por Proveedor: <strong>{{ $allData[0]->supplier->name }}</strong></h3>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-6 text-end">
                                                    ...
                                                    <tbody>
                                                        ...
                                                        @foreach ($allData as $key => $item)
                                                            ...
                                                            <tr>
                                                                ...
                                                                {{-- Unidades --}}
                                                                <td class="text-center" width="5%">{{ $item->unit->name }}</td>

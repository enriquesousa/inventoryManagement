            ...
            <div class="row">
                <div class="col-12">
                    <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                        ...
                        <h4 class="mb-sm-0">Lista todas las <strong>Facturas</strong></h4>
                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <h4 class="card-title">Lista todas las <strong>Facturas</strong></h4>
                            <p class="card-title-desc">Listado de todas las <code>Facturas</code>, aprobadas o pendientes por aprobar.</p>

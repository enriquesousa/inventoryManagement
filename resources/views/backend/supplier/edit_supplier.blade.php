            ...
            <div class="row">
                <div class="col-12">
                    <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                        <h4 class="mb-sm-0">Editar <strong>Proveedor</strong></h4>
                ...
                <div class="col-lg-12">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <h4 class="card-title">Editar <strong>Proveedor</strong></h4>
                            <p class="card-title-desc">Edite el <code>formulario</code> para modificar datos del proveedor.</p>

                            <form id="myForm" method="post" action="{{ route('update.supplier', $supplier->id) }}" enctype="multipart/form-data">
                                @csrf
